...
@php
    ...
    $dotBackground = [
        'dark' => 'bg-gray-600 peer-checked:bg-gray-300',
...
>
    <div class="relative">
        ...
        <div
            class="w-14 h-7 border border-gray-300 bg-gray-200 {{ $checkedBackground }} rounded-full transition-colors duration-300 ease-in-out"></div>
        <div
            class="absolute left-1 top-1 border border-gray-300 {{ $dotBackground }} size-5 rounded-full transition-transform duration-300 ease-in-out peer-checked:translate-x-7"></div>
    </div>
</label>
